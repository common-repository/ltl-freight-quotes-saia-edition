<?php
/**
 * SAIA WooComerce Admin Settings | Plugin Shipping Settings
...
/**
 * Add SAIA Method In WOO Method List
 * @param $methods
 * @return string
 */
function add_saia_logistics($methods)
{
    $methods['saia'] = 'SAIA_Freight_Shipping_Class';
    return $methods;
}

/**
 * Add Woo Setting Tab For SAIA
 * @param $settings
 * @return Woo Settings
 */
function saia_shipping_sections($settings)
{
    include('saia-tab-class.php');
    return $settings;
}
 ...
 */
function saia_hide_shipping($available_methods)
{
    if (get_option('saia_allow_other_plugins') == 'no'
 ...
 */
if (!function_exists("saia_no_method_available")) {

    function saia_no_method_available()
    {
