...
if (!class_exists('EnSaiaLfqLogs')) {
    class EnSaiaLfqLogs
    {
        ...
        {
            $obj_classs = new \SAIA_Curl_Request;
            $data = array(
                'serverName' => saia_quotes_get_domain(),
            ...
            $url = SAIA_HITTING_DOMAIN_URL . '/request-log/index.php';
            $logs = $obj_classs->saia_get_curl_response($url, $data);
