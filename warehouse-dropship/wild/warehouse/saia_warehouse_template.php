...
<script type="text/javascript">
    ...
    function saia_en_wd_add_warehouse_btn()
    {
    ...
    function change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php saia_warehouse_template(); ?>

    <!-- Add Popup for new warehouse -->
    <div id="saia_en_wd_add_warehouse_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup">
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form" onclick="return saia_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
