...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#en_wd_dropship_zip").keydown(function (e) {
            if (e.which != 8 && e.which != 9 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.keyCode < 65 || e.keyCode > 90) && (e.keyCode < 95 || e.keyCode > 122)) {
                return false;
            } else {
    ...
    function saia_hide_drop_val()
    {
        jQuery('#add_dropships')[0].reset();
        jQuery('.en_wd_saia_account_label').show();
    ...
    function saia_change_dropship_zip()
    {
...
//      check current zipcode and test connection zipcode is same then hide the account field
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-saia-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    <a href="#delete_dropship_btn" class="delete_dropship_btn saia_hide_drop_val"></a>
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input title="Zip" type="text" maxlength="7" value="" onchange="saia_change_dropship_zip()" name="en_wd_dropship_zip" placeholder="30214" id="en_wd_dropship_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    -->
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_dropship" value="Save" class="save_warehouse_form" onclick="return saia_en_wd_save_dropship();">
                    </div>
                </form>
            </div>
        </div>
