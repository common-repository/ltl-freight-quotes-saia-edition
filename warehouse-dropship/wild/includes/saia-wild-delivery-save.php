...
if (!class_exists("SaiaEnWooWdAddonsAjaxReqIncludes")) {

    class SaiaEnWooWdAddonsAjaxReqIncludes{
    ...
    public $EnWooAddonAutoResidDetectionTemplate;
        ...
        {
            add_action('wp_ajax_nopriv_en_wd_get_address', array($this, 'saia_get_address_api_ajax'));
            add_action('wp_ajax_en_wd_get_address', array($this, 'saia_get_address_api_ajax'));

            add_action('wp_ajax_nopriv_saia_en_wd_delete_dropship', array($this, 'saia_delete_dropship_ajax'));
            add_action('wp_ajax_saia_en_wd_delete_dropship', array($this, 'saia_delete_dropship_ajax'));

            add_action('wp_ajax_nopriv_saia_en_wd_save_warehouse', array($this, 'saia_save_warehouse_ajax'));
            add_action('wp_ajax_saia_en_wd_save_warehouse', array($this, 'saia_save_warehouse_ajax'));

            add_action('wp_ajax_nopriv_saia_en_wd_save_dropship', array($this, 'saia_save_dropship_ajax'));
            add_action('wp_ajax_saia_en_wd_save_dropship', array($this, 'saia_save_dropship_ajax'));


            add_action('wp_ajax_nopriv_saia_en_wd_edit_dropship', array($this, 'saia_edit_dropship_ajax'));
            add_action('wp_ajax_saia_en_wd_edit_dropship', array($this, 'saia_edit_dropship_ajax'));

            add_action('wp_ajax_nopriv_saia_en_wd_delete_warehouse', array($this, 'saia_delete_warehouse_ajax'));
            add_action('wp_ajax_saia_en_wd_delete_warehouse', array($this, 'saia_delete_warehouse_ajax'));

            add_action('wp_ajax_nopriv_saia_en_wd_edit_warehouse', array($this, 'saia_edit_warehouse_ajax'));
            add_action('wp_ajax_saia_en_wd_edit_warehouse', array($this, 'saia_edit_warehouse_ajax'));
        }

        /**
         * Get Address From ZipCode Using API
         */
        function saia_get_address_api_ajax() 
        {    
            if (isset($_POST['origin_zip'])) 
            {
                ...
                $accessLevel = 'address';                
                $Get_saia_quotes_distance = new Get_saia_quotes_distance();
                $resp_json = $Get_saia_quotes_distance->saia_quotes_get_distance($zipCode, $accessLevel);
         ...
         * @global $wpdb
         */
        function saia_save_warehouse_ajax() 
        {
            global $wpdb;
            $inputData = $_POST;
            $html = "";
                ...
                if (isset($validateData["city"])) 
                {
                    ...
                    else 
                    {
                        if (empty($get_warehouse)) 
                        {
                            ...
                            $html = saia_warehouse_template(TRUE);
                        }
                    }
                }
         ...
         * @global $wpdb
         */
        function saia_edit_warehouse_ajax() 
        {
            // Terminal phone number
            global $wpdb;
         ...
         * @global $wpdb
         */
        function saia_delete_warehouse_ajax() 
        {
            global $wpdb;
         ...
         * @global $wpdb
         */
        function saia_save_dropship_ajax() 
        {
            global $wpdb;
            $inputData = $_POST;
            $html = "";
                ...
                if (isset($validateData["city"])) 
                {
                    ...
                    else 
                    {
                        if (empty($get_dropship)) 
                        {
                            ...
                            $html = saia_dropship_template(TRUE);
                        }
                    }
                }
                $lastid = $wpdb->insert_id;
         ...
         * @global $wpdb
         */
        function saia_edit_dropship_ajax() 
        {
            // Terminal phone number
            global $wpdb;
         ...
         * @global $wpdb
         */
        function saia_delete_dropship_ajax() 
        {
            global $wpdb;
...
new SaiaEnWooWdAddonsAjaxReqIncludes();