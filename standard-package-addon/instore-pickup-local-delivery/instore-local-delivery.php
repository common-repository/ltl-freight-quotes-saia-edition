...
if (!class_exists("EnSAIAWDQuotes")) {

    class EnSAIAWDQuotes
    {

        public function __construct()
        {
            add_filter('en_wd_update_query_string', array($this, 'en_wd_update_query_string'), 10, 1);
            add_filter('en_saia_wd_origin_array_set', array($this, 'en_saia_wd_origin_array_set'), 10, 1);
            add_filter('en_wd_saia_standard_plans', array($this, 'en_wd_standard_plans'), 10, 4);
         ...
         * @return array type
         */
        public function en_saia_wd_origin_array_set($origin)
        {
            ...
            $saia_account = (isset($origin->saia_account)) ? $origin->saia_account : "";
            ...
            return array(
                ...
                'location' => $location,
                'country' => $country,
                'saia_account' => $saia_account,
                'account_number' => $saia_account,
        ...
        function check_package_plan($package)
        {
            ...
            $action = apply_filters('saia_quotes_quotes_plans_suscription_and_features', 'instore_pickup_local_devlivery');
